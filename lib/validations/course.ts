...
export const createCourseSchema = z.object({
  ...
  category: z.enum(['vocabulary', 'grammar', 'conversation', 'reading', 'writing', 'culture', 'kanji', 'language']),
...
export const updateCourseSchema = z.object({
  ...
  category: z.enum(['vocabulary', 'grammar', 'conversation', 'reading', 'writing', 'culture', 'kanji', 'language']).optional(),
